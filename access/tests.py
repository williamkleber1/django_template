...
class ResetPasswordControlTests(TestCase):
    ...
    def test_create_reset_password_control(self):
        ...
        reset_control = ResetPasswordControl.objects.create(email="test@example.com")
...
class LoggedDeviceTests(TestCase):
    ...
    def test_update_last_login(self):
        ...
        device = LoggedDevice.objects.create(
            user=self.user, device_type="desktop", device_name="Chrome Browser"
        )
...
class PreRegisterTests(TestCase):
    ...
    def test_create_pre_register(self):
        ...
        pre_register = PreRegister.objects.create(email="test@example.com")
...
class APITests(APITestCase):
    ...
    def test_user_login(self):
        ...
        login_data = {"email": "api@example.com", "password": "apipass123"}
...
class SerializerTests(TestCase):
    ...
    def test_logged_device_serializer_unique_constraint(self):
        ...
        LoggedDevice.objects.create(
            user=self.user, device_type="desktop", device_name="Chrome"
        )

        # Try to create duplicate
        data = {"device_type": "desktop", "device_name": "Chrome"}
