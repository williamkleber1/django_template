...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'userId', 'username', 'email', 'avatar', 'phone_number', 'birth_date',
            'dalle_credits', 'subscription_credits', 'is_email_confirmed',
            'notification_settings', 'created', 'updated', 'password', 'password_confirm'
        )
        read_only_fields = ('userId', 'created', 'updated', 'dalle_credits', 'subscription_credits')
